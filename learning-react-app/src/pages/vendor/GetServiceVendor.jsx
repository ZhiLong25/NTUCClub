...
function GetServiceVendor() {
  ...
  const searchServices = () => {
    http.get(`/Product/getvendorservice/${name.name}/${search}`).then((res) => {
      console.log("pres")
                ...
                <Card>
                  <CardContent>
                    ...
                    <Box sx={{ display: 'flex', mb: 1 }}>
                      ...
                      <Link to={`/editservicevendor/${services.id}`}>
...
export default GetServiceVendor